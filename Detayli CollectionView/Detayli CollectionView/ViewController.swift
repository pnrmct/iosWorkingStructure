...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let hucreGenislik = (genislik-70)/2
        ...
        let f3 = Filmler(filmId: 3, filmBaslik: "Interstellar", filmResimAdi: "interstellar", filmFiyat: 12.99)
        let f4 = Filmler(filmId: 4, filmBaslik: "Anadoluda", filmResimAdi: "birzamanlaranadoluda", filmFiyat: 4.99)
        let f5 = Filmler(filmId: 5, filmBaslik: "The Hateful Eight", filmResimAdi: "thehatefuleight", filmFiyat: 8.00)
        let f6 = Filmler(filmId: 6, filmBaslik: "The Pianist", filmResimAdi: "thepianist", filmFiyat: 10.99)
...
extension ViewController:UICollectionViewDelegate,UICollectionViewDataSource,FilmHucreProtocol{
    ...
    func sepeteEkle(indexPath: IndexPath) {
        ...
        print("\(film.filmBaslik!) film sipariş verildi")
    }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        let film = filmlerListesi[indexPath.row]
        print("\(film.filmBaslik!) film seçildi")
    }
}
